...
#Region "Download: File transfer FROM ftp server"
        ...
        Public Function Download(ByVal sourceFilename As String) As String
        ...
        Public Function Download2(ByVal sourceFilename As String) As StreamReader
...
#End Region
        ...
        Sub New(ByVal line As String, ByVal path As String)
            ...
            Else
                ...
                _path = path				
                _size = 100 'CLng(m.Groups("size").Value)
